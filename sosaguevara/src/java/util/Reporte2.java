...
public class Reporte2 {
    ...
    public void getReporte(Integer accnum) throws ClassNotFoundException, ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException, JRException, IOException {
